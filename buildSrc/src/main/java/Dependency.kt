object Dependency {
    object Androidx {
        ...
        const val HILT_VIEWMODEL =
            "androidx.hilt:hilt-navigation-compose:${Versions.HILT_VIEWMODEL}"
    }
    ...
    object Compose {
        ...
        const val LANDSCAPIST_COMPOSE =
            "com.github.skydoves:landscapist-glide:${Versions.LANDSCAPIST_COMPOSE}"
    }
